          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {MAINTENANCE_ITEMS.map((item) => (
              ...
              >
                ...
                <button className={`text-xs font-medium px-2 py-1 rounded transition-colors bg-white dark:bg-surface-dark border ${
                  item.isUrgent 
                ...
                <tr key={booking.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      booking.status === BookingStatus.ACTIVE ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200' :
