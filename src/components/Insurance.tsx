                      ...
                      <div className="relative">
                        ...
                        >
                          {newRecord.vehicle_id ? (
                            (() => {
                              const v = vehicles.find(v => v.id === newRecord.vehicle_id);
                              return v ? (
                                ...
                                {vehicles
                                  ...
                                  .map(v => (
                                    <button
                                      ...
                                      type="button"
                                      onClick={() => {
                                        setNewRecord({ ...newRecord, vehicle_id: v.id });
                                    ...
                                    >
                                      <div className="flex items-center justify-between w-full">
                                        ...
                                        {newRecord.vehicle_id === v.id && <span className="material-symbols-outlined text-primary text-sm">check</span>}
                                      </div>
                                      <span className="text-xs text-slate-500">{v.name}</span>
                                    </button>
                                  ))}
